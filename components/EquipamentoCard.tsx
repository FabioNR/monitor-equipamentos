  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <h3 className="truncate text-sm font-semibold text-white">{equipamento.nome}</h3>
      </div>
      <p className="mt-1 truncate pl-4 text-xs text-slate-400">{equipamento.localizacao}</p>
    </button>
  );
}